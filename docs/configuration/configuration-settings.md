...
| -----       | -------     | ------------    | --------------   | ----------- |
| LSAM Name   | IBMILSAM    | IBM i Name (Refer to [IBM i Name Rules](#ibm-i-name-rules)) | Y           | - This field identifies each LSAM environment to OpCon. |
...
| SMA Subsystem Name | SMASBS      | IBM i Name (Refer to [IBM i Name Rules](#ibm-i-name-rules))| Y           | - This field contains the name of the IBM i subsystem where the LSAM agent jobs run. |
